...
В разделе *Directory information* заполняем: описание, контактные данные, изображение... Дополняем *Additional invocation phrases* согласно [документации фраз запуска приложения](https://developers.google.com/assistant/console/languages-locales). Нажимаем *Save*. В разделе *Release* публикуем проект...
